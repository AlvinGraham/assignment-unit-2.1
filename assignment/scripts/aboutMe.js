...
console.log('adventurous variable is assigned ' + adventurous);

// 7 - Create a variable named `food`, and set its value to a string of your favorite food
//     Console log the value of `food`
let food = 'lasagna';
console.log('food variable is assigned ' + food);

// 8 - Create a variable called `pets` and set it to the value of the number of pets you have
//     Console log the value of `pets`
let pets = 2;
console.log('pets variable is assigned ' + pets);

// 9 - Create a variable called `friendsPets` and assign it the value of the number of pets your friend has
let friendsPets = 6;
console.log('friendPets variable is assigned ' + friendsPets);

// 10 - Add two pets to your `pets` variable
pets += 2;
console.log('pets variable is now ' + pets);

// 11 - Create a constant variable called `allowedPets` and set it to a number value of your choice
const allowedPets = 3;
console.log('allowedPets constant variable is assigned ' + allowedPets);
...
// I acknowledge that in the above conditionals, the final if is superflous and could
// be ommitted with the same end result.  That is..
// } else {
//   petStatus = 'Oh no, I have too many pets!';
// }
...
if (pets === 0 && friendsPets === 0){
  mostPets = 0;
  console.log('Neither of us have any pets');
...
// 12 (STRETCH) - Reassign result variable to undefined. Create a "ternary if", where
//      if adventurous is true, set `result` to be "Adventures are great!", 
//      if it's not true,  set `result` to be "How about we stay home?"
//      Console log the value of `result`

result = undefined; //reset result to null undefined value
